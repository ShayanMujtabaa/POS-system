  ...
  return (
    <div className="p-4">
      <div className="flex">
        <div
          className={`p-4 ${
            cartItems.length > 0 ? "w-full lg:w-2/3" : "w-full"
          }`}
        >
          ...
          {loading && <SkeletonVariations loading={loading} />}
              ...
              <div
                ...
                className={`w-full px-2 ${
                  cartItems.length <= 0
                    ...
                    : "sm:w-1/1 md:w-1/2 lg:w-1/2 xl:w-1/4"
                }`}
              >
                <ItemCard
                  item={item}
                  onClick={() => handleAddToCartHelper(item)}
                />
              </div>
            ))}
          </div>
