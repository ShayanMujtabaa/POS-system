...
const AddExpense = () => {
    ...
    const handleAddExpense = async (e) => {
        ...
        if (!ExpenseID || !ExpenseName || !ExpensePrice) {
        ...
        try {
            const ExpenseData = {
                id: ExpenseID, name: ExpenseName, price: ExpensePrice
            };
            ...
            console.log("Error while adding Expense: ", error.msg);
    ...
    return (
        <div className="container mt-24 mx-auto px-12 py-4">
            ...
            <form onSubmit={handleAddExpense}>
                <div>
                    <label className="text-white block mb-2 text-2xl font-medium my-2" >Expense ID</label>
                    <input
                        type="text"
